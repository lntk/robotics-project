...
# Demo
register(
    id='GazeboTurtlebotSimpleMaze-v0',
    entry_point='gym_gazebo.envs.turtlebot:GazeboSimpleMazeEnv',
)

register(
    id='GazeboTurtlebot180Maze-v0',
    entry_point='gym_gazebo.envs.turtlebot:Gazebo180MazeEnv',
)

register(
    id='GazeboTurtlebotObstacleMaze-v0',
    entry_point='gym_gazebo.envs.turtlebot:GazeboObstacleMazeEnv',
)
