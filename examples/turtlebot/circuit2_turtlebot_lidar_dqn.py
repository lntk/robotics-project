...
if __name__ == '__main__':
    ...
    weights_path = '/home/lntk/Desktop/turtle_guided_dqn.h5'
    # monitor_path = '/tmp/turtle_c2_dqn_ep200'
    params_json  = '/home/lntk/Desktop/turtle_guided_dqn.json'
    ...
    for epoch in xrange(current_epoch+1, epochs+1, 1):
        ...
        for t in xrange(steps):
            ...
            action = LaserScanProcess(observation)
            newObservation, reward, done, info = env.step(action)
            norm_newObservation = normalize(newObservation)
            # if not done:
            ...
            deepQ.addMemory(norm_observation, action, reward, norm_newObservation, done)
            ...
            if done:
                ...
                if (epoch)%5==0:
                    print ("Saving model ...")	
                    deepQ.saveModel('/home/lntk/Desktop/turtle_guided_dqn'+'.h5')
                    ...
                    with open('/home/lntk/Desktop/turtle_guided_dqn'+'.json', 'w') as outfile:
